        ...
        mPassword.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mPassword.getInputType() == (InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD)) {
                    ...
                    passwordVisibilityIcon.setImageResource(R.drawable.no_eye_password);
                } else {
                    mPassword.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
                    passwordVisibilityIcon.setImageResource(R.drawable.password_eye_icon);
                }
            }
        });
        ...
        mAuth.createUserWithEmailAndPassword(email,password).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    String defaultImageUrl = "gs://challenger-88958.appspot.com/default_profile_picture.jpg";
                    user.put("profileImageUrl",defaultImageUrl);
                    List<String> challangeIds = new ArrayList<>();
                    user.put("myChallangesId", challangeIds);
