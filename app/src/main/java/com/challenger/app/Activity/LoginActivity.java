...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.iddd), (v, insets) -> {
        ...
        switchPasswordVisibilty.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (passwordEditText.getInputType() == (InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD)) {
                    ...
                    switchPasswordVisibilty.setVisibility(View.VISIBLE);
                    switchPasswordVisibilty.setImageResource(R.drawable.no_eye_password);
                } else {
                    passwordEditText.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
                    switchPasswordVisibilty.setImageResource(R.drawable.password_eye_icon);
                }
            }
        });
